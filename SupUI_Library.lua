...
Refresh=function(ay,az)
al=az or{}
local aA=math.min(#al,ak.MaxVisible or 6)
local aB=math.max(aA,1)*(ap+2)+8
local aC=aB+(ao and 22 or 0)+10
av.Size=UDim2.new(1,-i.pad_sm,0,aB)
au.Size=UDim2.new(1,0,0,aC)
buildItems()
end,
